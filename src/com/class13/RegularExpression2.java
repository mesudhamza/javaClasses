...
public class RegularExpression2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("***************");
		System.out.println(str.replaceAll("\\s", ""));//does the same thing as above removes the spaces and replace them with nothing
		...
		System.out.println(doc.replaceAll("powerful(.*)", ""));//ignores everything in the text coming after powerful including powerful
